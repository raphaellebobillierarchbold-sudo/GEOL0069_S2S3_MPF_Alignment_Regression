...
- GEOL0069 AI for Earth Observation course guidebooks and practical notebooks. Used for the Sentinel-2/Sentinel-3 colocation workflow, MPF regression setup, ECC alignment experiment, Gaussian Process regression, and XAI feature-importance methods.

- ESA / Copernicus Sentinel-2 mission documentation. Used for background on Sentinel-2 optical imagery and its role as the higher-resolution source for the MPF target.

- ESA / Copernicus Sentinel-3 OLCI mission documentation. Used for background on Sentinel-3 OLCI and its 21-band multispectral reflectance data.
...
- GPy documentation. Used for Gaussian Process regression.
